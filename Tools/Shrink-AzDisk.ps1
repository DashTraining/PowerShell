[CmdletBinding()]
param() {
	$ExistingDiskID         = "/subscriptions/{ID}/resourceGroups/DASH-Demo-rg/providers/Microsoft.Compute/disks/DASH-Demo-vm_disk1"

	$VMName         = "DASH-Demo-vm"

	$DiskSizeGB     = 32

	$AzSubscription = "Dash Training"

	# Name of the Managed Disk
	$NewDiskName    = "DASH-Demo-vhd"
}
...
# Get Disk from ID
$Disk = Get-AzDisk | ? Id -eq $ExistingDiskID
...
Start-Sleep 180
Read-Host -Prompt 'Please check the VM is running before proceeding with the tidy-up steps...'
